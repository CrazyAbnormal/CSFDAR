SERVICES VUE - FUNCTIONING BEFORE THE INTEGRATION OF CSF FORM
...
const goToSurvey = (serviceId) => {
    router.visit(`/survey-form?service_id=${serviceId}`);
};
